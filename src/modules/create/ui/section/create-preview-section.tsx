...
export const PreviewSection = ({ form, name }: PreviewSectionProps) => {
  ...
  return (
    <div className="sticky top-10 mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            <div className="md:col-span-2 flex flex-col">
              ...
              <div className="flex w-full gap-2">
                <Button className="flex-1 w-fit">Beli Sekarang</Button>
                <Button className="flex-1 w-fit" variant={"secondary"}>
                  Tambah ke Keranjang
                </Button>
              </div>
